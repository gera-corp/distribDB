...
urlpatterns = [
    ...
    path('tables/drop_devices/<uuid:id>/delete/', views.drop_device_delete, name='drop_device_delete'),
    ...
    path('tables/hasp_keys/<uuid:id>/delete/', views.hasp_keys_delete, name='hasp_keys_delete'),
    ...
    path('tables/hardlock_keys/<uuid:id>/delete/', views.hardlock_keys_delete, name='hardlock_keys_delete'),
    ...
    path('tables/plane_types/<uuid:id>/delete/', views.plane_types_delete, name='plane_types_delete'),
    ...
    path('tables/lang_types/<uuid:id>/delete/', views.lang_types_delete, name='lang_types_delete'),
    ...
    path('tables/os_types/<uuid:id>/delete/', views.os_types_delete, name='os_types_delete'),
    ...
    path('tables/executables/<uuid:id>/delete/', views.executables_delete, name='executables_delete'),
    ...
    path('tables/fas_modules/<uuid:id>/delete/', views.fas_modules_delete, name='fas_modules_delete'),
    ...
    path('tables/executable_paths/<uuid:id>/delete/', views.executable_paths_delete, name='executable_paths_delete'),
    ...
    path('tables/regsystems/<uuid:id>/delete/', views.regsystems_delete, name='regsystems_delete'),
    ...
    path('tables/typeregsys/<uuid:id>/delete/', views.typeregsys_delete, name='typeregsys_delete'),
    ...
    path('tables/tasks/<uuid:id>/delete/', views.tasks_delete, name='tasks_delete'),
    ...
    path('tables/typetasks/<uuid:id>/delete/', views.typetasks_delete, name='typetasks_delete'),
    ...
    path('tables/misc/<uuid:id>/delete/', views.misc_delete, name='misc_delete'),
    ...
    path('tables/typemisc/<uuid:id>/delete/', views.typemisc_delete, name='typemisc_delete'),
    ...
    path('tables/organisations/<uuid:id>/delete/', views.organisations_delete, name='organisations_delete'),
    ...
    path('tables/regsysdevices/<uuid:id>/delete/', views.regsysdevices_delete, name='regsysdevices_delete'),
    ...
    path('tables/modules/<uuid:id>/delete/', views.modules_delete, name='modules_delete'),
    ...
    path('tables/drivers/<uuid:id>/delete/', views.drivers_delete, name='drivers_delete'),
