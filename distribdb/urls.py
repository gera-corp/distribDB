...
urlpatterns = [
    ...
    path('drop_devices/new_post/', views.drop_device_new_post),
    ...
    path('hasp_keys/new_post/', views.hasp_keys_new_post),
    ...
    path('hardlock_keys/new_post/', views.hardlock_keys_new_post),
    ...
    path('plane_types/new_post/', views.plane_types_new_post),
    ...
    path('lang_types/new_post/', views.lang_types_new_post),
    ...
    path('os_types/new_post/', views.os_types_new_post),
    ...
    path('executables/new_post/', views.executables_new_post),
    ...
    path('fas_modules/new_post/', views.fas_modules_new_post),
    ...
    path('executable_paths/new_post/', views.executable_paths_new_post),
    ...
    path('regsystems/new_post/', views.regsystems_new_post),
    ...
    path('typeregsys/new_post/', views.typeregsys_new_post),
    ...
    path('tasks/new_post/', views.tasks_new_post),
    ...
    path('typetasks/new_post/', views.typetasks_new_post),
    ...
    path('misc/new_post/', views.misc_new_post),
    ...
    path('typemisc/new_post/', views.typemisc_new_post),
    ...
    path('organisations/new_post/', views.organisations_new_post),
    ...
    path('regsysdevices/new_post/', views.regsysdevices_new_post),
    ...
    path('modules/new_post/', views.modules_new_post),
